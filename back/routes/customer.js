...
var cauthenticate = require('../middlewares/cauthenticate.js');
...
api.get('/obtener_direccion_cliente',cauthenticate.decodeToken,customerController.obtener_direccion_cliente);
