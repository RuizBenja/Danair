...
api.get('/obtener_productos_relacionados_categoria/:categoria',publicController.obtener_productos_relacionados_categoria);
api.get('/obtener_reviews_productos/:id',publicController.obtener_reviews_productos);
