            ...
            <div class="card">
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <div class="btn-group">
                      <button class="btn btn-sm btn-white border" @click="downloadCsv" :disabled="!filteredServicios.length">
                        CSV
                      </button>
                      <button class="btn btn-sm btn-white border" @click="printTable" :disabled="!filteredServicios.length">
                        Imprimir
                      </button>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    getExportRows() {
      return this.filteredServicios.map((item) => ({
        titulo: item.titulo || '',
