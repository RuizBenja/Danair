                ...
                <div class="row align-items-center">
                  <div class="col">
                    <ul class="nav nav-tabs nav-overflow header-tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active">Nuevo servicio</a>
                      </li>
                    </ul>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      axios.post(this.$url + '/servicio', data, {
        headers: {
          'Content-Type': 'multipart/form-data',
          Authorization: this.$store.state.token
        }
      }).then(() => {
        this.$notify({ group: 'foo', title: 'EXITO', text: 'Servicio guardado', type: 'success' });
