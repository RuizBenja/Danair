        ...
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="row align-items-center">
                  <div class="col">
                    <ul class="nav nav-tabs nav-overflow header-tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active">Nuevo proyecto destacado</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <ProyectoForm
              ...
              submit-label="Crear proyecto destacado"
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      axios.post(this.$url + '/proyecto', data, {
        headers: {
          'Content-Type': 'multipart/form-data',
          Authorization: this.$store.state.token
        }
      }).then(() => {
        this.$notify({ group: 'foo', title: 'EXITO', text: 'Proyecto guardado', type: 'success' });
