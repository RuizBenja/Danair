...
const routes = [
  ...
  { path: '/dashboard', name: 'dashboard', component: ()=> import('@/views/DashboardApp.vue'), meta: { requiresAuth: true, roles: ['Administrador','Vendedor','Inventariado'] }},
  { path: '/perfil', name: 'perfil', component: ()=> import('@/views/PerfilApp.vue'), meta: { requiresAuth: true, roles: ['Administrador','Vendedor','Inventariado'] }},
  ...
  { path: '/marcas', name: 'marcas', component:()=>import ('@/views/MarcasApp.vue') , meta: { requiresAuth: true, roles: ['Administrador','Inventariado'] }},
  { path: '/marcas/create', name: 'marcas-create', component:()=>import ('@/views/CreateMarcaApp.vue') , meta: { requiresAuth: true, roles: ['Administrador','Inventariado'] }},
  { path: '/marcas-producto', name: 'marcas-producto', component:()=>import ('@/views/MarcasProductoApp.vue') , meta: { requiresAuth: true, roles: ['Administrador','Inventariado'] }},
  { path: '/marcas-producto/create', name: 'marcas-producto-create', component:()=>import ('@/views/CreateMarcaProductoApp.vue') , meta: { requiresAuth: true, roles: ['Administrador','Inventariado'] }},
  { path: '/servicios', name: 'servicios', component:()=>import ('@/views/ServiciosApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
  { path: '/servicios/create', name: 'servicios-create', component:()=>import ('@/views/CreateServicioApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
  { path: '/servicios/edit/:id', name: 'servicios-edit', component:()=>import ('@/views/EditServicioApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
  { path: '/servicios-tecnicos', name: 'servicios-tecnicos', component:()=>import ('@/views/ServiciosTecnicosApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
  { path: '/proyectos', name: 'proyectos', component:()=>import ('@/views/ProyectosApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
  { path: '/referencias', name: 'referencias', component:()=>import ('@/views/ReferenciasApp.vue') , meta: { requiresAuth: true, roles: ['Administrador'] }},
]
