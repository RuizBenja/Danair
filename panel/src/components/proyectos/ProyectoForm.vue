    ...
    <div class="card-body">
      <div class="row g-3">
        <div class="col-12 col-lg-6">
          ...
          <input
            ...
            class="form-control"
            v-model="form.titulo"
            placeholder="Ej: Modernizacion de sala de compresores"
          />
        ...
        <div class="col-12">
          ...
          <div class="project-file-box d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
            ...
            <div class="text-muted small project-file-help">
        ...
        <div class="col-12">
          ...
          <textarea
            ...
            placeholder="Descripcion principal del proyecto"
          ></textarea>
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mt-4 border-top pt-3">
        ...
        <div class="d-flex align-items-center gap-2">
          <router-link v-if="showCancel" to="/proyectos" class="btn btn-danger cancel-button">
            Cancelar
          </router-link>
...
export default {
  ...
  props: {
    ...
    submitLabel: { type: String, default: 'Guardar proyecto' },
