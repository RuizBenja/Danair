    ...
    <div class="card-body">
      <div class="row g-3">
        <div class="col-12 col-lg-6">
          ...
          <input
            ...
            class="form-control"
            v-model="form.titulo"
            placeholder="Ej: Auditorias y Estudios"
          />
        ...
        <div class="col-12">
          ...
          <textarea
            ...
            placeholder="Contenido principal de la pagina del servicio"
          ></textarea>
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mt-4 border-top pt-3">
        ...
        <div class="d-flex align-items-center gap-2">
          <router-link v-if="showCancel" to="/servicios" class="btn btn-danger cancel-button">
            Cancelar
          </router-link>
...
export default {
  ...
  props: {
    ...
    submitLabel: { type: String, default: 'Guardar servicio' },
